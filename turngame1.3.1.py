...
In this game, you have 50 turns and your goal is to try to not die. 
...
but level 2 and 3 enemies can upgrade armor. If you win, you will be rewarded with points.
"""
